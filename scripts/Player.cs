	...
	*/
    ...
    public override void _PhysicsProcess(double delta) {
        ...
        if (isInitialized == false) {
            GD.Print("PlayerType not setup :: " + CharType.ToString());
            InitializeAnimation();
        }
    }
    ...
    public void InitializeAnimation() {
        ...
        switch (type) {
            ...
            case CharacterType.Player:
                ...
                SetAnim(ActionStateType.idle);
                WalkSpeed = 120;
                CharSprite1.Scale = new Vector2(CharSprite1.Scale.X * .5f, CharSprite1.Scale.Y * .5f);
                CharSprite2.Scale = new Vector2(CharSprite2.Scale.X * .5f, CharSprite2.Scale.Y * .5f);
                GD.Print("Setting Player Settings.");
            ...
            switch (type) {
                case ActionStateType.idle:
                    ...
                    if (actionType != ActionStateType.idle) {
                        ...
                        lockDirection = false;
                        spriteSwapped = true;
                        setSprite.Texture = GD.Load<Texture2D>(_ROOT_PATH + "/Player/Walk/PlayerWalk.png");
                        setSprite.Hframes = 12;
                ...
                case ActionStateType.attack1:
                    ...
                    if (actionType != ActionStateType.attack1) {
                        ...
                        lockDirection = true;
                        spriteSwapped = true;
                        setSprite.Texture = GD.Load<Texture2D>(_ROOT_PATH + "/Player/Att1SwordSwing/PlayerAtt1.png");
                        setSprite.Hframes = 14;
